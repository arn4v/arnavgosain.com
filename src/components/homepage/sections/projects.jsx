      ...
      <div className="grid grid-flow-row gap-4 lg:grid-rows-2 lg:grid-cols-2 lg:gap-6">
        {projects.map((p) => {
          return (
            <div
              key={p.name}
              className="flex flex-col items-start justify-center w-full h-full gap-3 p-4 rounded-md shadow-sm dark:shadow-inner dark:bg-gray-900 dark:hover:bg-gray-800 transiton duration-100 ease-out dark:text-white bg-gray-100 hover:bg-gray-200 border border-gray-300 dark:border-gray-700 hover:shadow-md"
            >
