...
export default function Navbar({ className = '' }: Props) {
	...
	return (
		<nav
			className={clsx([
				className,
				'h-20 w-full dark:bg-black bg-white border-b border-gray-200 dark:border-slate-600 fixed top-0 z-50 transition-shadow duration-100 ease-in-out',
		...
		>
			<div className="flex w-full items-center justify-between h-full lg:max-w-4xl px-6 lg:px-0 mx-auto">
				<div className="items-center justify-start gap-4 flex">
					<button onClick={onToggle} className="focus:outline-none dark:text-white lg:hidden">
