...
const projects = [
	...
	},
	{
		...
		tags: ['React', 'Next.js', 'TypeScript', 'tRPC', 'TailwindCSS', 'Framer Motion']
	},
	{
		name: 'Docguard',
	...
	},
	{
		...
		description: (
			<>
				Next.js plugin that adds support for MDX Pages with layout support in frontMatter. Inspired
				by{' '}
				<Link href="https://github.com/hashicorp/next-mdx-enhanced" className="">
					next-mdx-enhanced
				</Link>
				, powered by{' '}
				<Link
	...
	},
	{
		...
		description: (
			<>
				...
				<DescLink href="https://github.com/thesephist/mira">mira</DescLink>. Built with Golang and
				Svelte.
			</>
		),
		links: [
	...
	},
	{
		...
		name: 'use-children',
		description: 'React hook for filtering the `children` for a specific component',
		duration: 'July 2021',
		links: [
			{
	...
	},
	{
		...
		description: (
			<>
				Simple URL shortener built to test <Link href="https://upstash.com">Upstash.com's</Link>{' '}
	...
	{
		name: 'Portfolio',
		description: 'My portfolio (this website) built with Next.js, React and TailwindCSS.',
	...
	{
		name: 'Onetab2Sqlite',
		description: 'Another weapon in my infovore arsenal, adds OneTab links to an sqlite database.',
	...
	},
	{
		...
		description: 'A script to automate the building and signing of opensource Android apps I use.',
