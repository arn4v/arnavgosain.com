			...
			<PageLayout breadcrumb={{ Bookshelf: '/bookshelf' }} seo={seoConfig}>
				<div className="flex flex-col items-start justify-between space-y-8">
					{Object.entries(data).map(([key, value], index) => {
						return (
							<div key={index} className="flex flex-col items-start justify-start w-full space-y-4">
								<h1 className="sticky top-0 text-2xl font-bold dark:text-gray-200">{key}</h1>
